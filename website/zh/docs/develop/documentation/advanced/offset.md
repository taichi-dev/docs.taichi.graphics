...
::: note The dimensionality of field shapes should **be consistent** with that of the offset. Otherwise, a `AssertionError` will be raised. ::: Otherwise, a `AssertionError` will be raised. :::
